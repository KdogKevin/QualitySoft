...
public class ContactList implements Serializable {
	...
	private static Contact tempContact = new Contact();
	...
	/**
	 * This method prompts the user for the lastname, if no last name is entered
	 * it returns false. If entered then prompts the user for firstname and then
	 * stores the names for the contact in a name object
	 */
	...
	/**
	 * This method prompts the user for address info and then stores the address
	 * info for the contact in a StreetAddress object
	 */
	...
	/**
	 * This method prompts the user for email, phone-number and Note (if
	 * wanted), then stores the info in the contact object
	 */
	...
	/**
	 * This method stores the Contact() in the next open spot in the
	 * ContactList[]
	 */
